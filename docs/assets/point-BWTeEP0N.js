import{E as z}from"./mermaid-pFY79eek.js";import{m as J,p as K,c as y,B as Z}from"./editor-demo-r3K5I51n.js";import"./index-CMzo2fhN.js";function P(n,t){if(t.line!==null){const i=Math.min(Math.max(t.line,1),n.doc.lines);return n.doc.line(i).from}if(t.find!==null){const i=n.doc.toString().indexOf(t.find);return i===-1?null:i}return 0}const q="Rollbacks re-deploy the previous tag.",B="Re-deploy the previous tag, nothing else.",G=`# Rollback runbook
